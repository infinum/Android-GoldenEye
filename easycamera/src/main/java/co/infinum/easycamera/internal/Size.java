 ...
 * Backport of {@link android.util.Size} from SDK 23.
 */
public class Size {
    ...
    public static Size parseSize(@NonNull String string) throws NumberFormatException {
        ...
        try {
            return new Size(Integer.parseInt(string.substring(0, sepIx)),
                    Integer.parseInt(string.substring(sepIx + 1)));
